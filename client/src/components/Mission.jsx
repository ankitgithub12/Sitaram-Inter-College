            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
              <div className="stat-card text-white text-center p-8 rounded-2xl shadow-2xl transform hover:scale-105 transition duration-500">
                <div className="text-5xl font-bold mb-2 relative">
                  96%
                  <div className="absolute -top-2 -right-2 w-4 h-4 bg-sricgold rounded-full animate-ping"></div>
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-sricgold to-yellow-500 text-sricblue relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link 
              to="/admission-form" 
              className="bg-sricblue hover:bg-sricblue text-white font-bold py-4 px-8 rounded-xl transition duration-300 transform hover:scale-105 shadow-lg"
            >
              Start Your Journey
            </Link>
            <Link 
